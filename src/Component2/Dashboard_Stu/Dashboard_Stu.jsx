      ...
      <div className='Dashboard_Student_Main_Wrap' >
        <div className='Dashboard_Student_Info_Right' >
          <div className='Dashboard_Student_Info_Detail'>
            <img src='/UserImg.png' alt='' className='Dashboard_Student_Info_Img' />
            <h3>Suliton</h3>
          </div>
          <div className='Dashboard_Student_info'>
            <div className='Dashboard_Student_detail'>
              <h5>Reg No:</h5>
              <h5>001</h5>
            </div>
            <div className='Dashboard_Student_detail'>
        ...
        <div className='Dashboard_Student_Left'>
          <div className='Dashboard_Student_Msg' >
